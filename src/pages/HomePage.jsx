...
export default HomePage;
  ...
  // <main className="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200 ps ps--active-y">
        ...
        //                     </span>
        //                     <div className="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
        //                     <h6 className="mb-0 font-semibold leading-normal text-sm text-slate-700">New order #1832412</h6>
        //                     <p className="mt-1 mb-0 font-semibold leading-tight text-xs text-slate-400">21 DEC 11 PM</p>
        //                     </div>
        //                 </div>
        //                 <div className="relative mb-4 after:clear-both after:table after:content-['']">
        //                     <span className="w-6.5 h-6.5 text-base absolute left-4 z-10 inline-flex -translate-x-1/2 items-center justify-center rounded-full bg-white text-center font-semibold">
        ...
        //                     </span>
        //                     <div className="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
        //                     <h6 className="mb-0 font-semibold leading-normal text-sm text-slate-700">Server payments for April</h6>
        //                     <p className="mt-1 mb-0 font-semibold leading-tight text-xs text-slate-400">21 DEC 9:34 PM</p>
        //                     </div>
        //                 </div>
        //                 <div className="relative mb-4 after:clear-both after:table after:content-['']">
        //                     <span className="w-6.5 h-6.5 text-base absolute left-4 z-10 inline-flex -translate-x-1/2 items-center justify-center rounded-full bg-white text-center font-semibold">
        ...
        //                     </span>
        //                     <div className="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
        //                     <h6 className="mb-0 font-semibold leading-normal text-sm text-slate-700">New card added for order #4395133</h6>
        //                     <p className="mt-1 mb-0 font-semibold leading-tight text-xs text-slate-400">20 DEC 2:20 AM</p>
        //                     </div>
        //                 </div>
        //                 <div className="relative mb-4 after:clear-both after:table after:content-['']">
        //                     <span className="w-6.5 h-6.5 text-base absolute left-4 z-10 inline-flex -translate-x-1/2 items-center justify-center rounded-full bg-white text-center font-semibold">
        ...
        //                     </span>
        //                     <div className="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
        //                     <h6 className="mb-0 font-semibold leading-normal text-sm text-slate-700">Unlock packages for development</h6>
        //                     <p className="mt-1 mb-0 font-semibold leading-tight text-xs text-slate-400">18 DEC 4:54 AM</p>
        //                     </div>
        //                 </div>
        ...
        //                     </span>
        //                     <div className="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
        //                     <h6 className="mb-0 font-semibold leading-normal text-sm text-slate-700">New order #9583120</h6>
        //                     <p className="mt-1 mb-0 font-semibold leading-tight text-xs text-slate-400">17 DEC</p>
        //                     </div>
        //                 </div>
        //                 </div>
        //             </div>
